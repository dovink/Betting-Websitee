...
import {createFootBallSeason, getAllSeasons, getCurrentSeason,getSeasonTeams, makeTop4Guess, getGamesForSeason, AddGame, updateWinner, voteForFootballGame, updateTop4Winners, LeaderBoard } from "../Controllers/FootBallController.js";
...
footBallRouter.get("/footballSeason/current", verifyToken,getCurrentSeason);
