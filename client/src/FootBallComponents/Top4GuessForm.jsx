...
const Top4Guess = ({ seasonId, participatingTeams }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`http://localhost:5050/footballSeason/${seasonId}/makeTop4Guess`, {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="form-container">
      <h2 className='font-bold'>Pasirinkite savo TOP4 šio sezono komandas</h2>
      <form onSubmit={handleSubmit}>
        <div className="">
          <label className='font-medium'>Mano TOP4 komandos:</label>
          <Select
            isMulti
