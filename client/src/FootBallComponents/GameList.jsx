                  ...
                  >
                     <div className="flex items-center justify-between">
                        {gameHasEnded ? (
                           <div className="flex items-center w-1/4">
                              ...
                              <span className="font-bold px-2 text-red-900">
                                 vs
                              </span>
                              <span className="text-gray-500 font-bold py-2">
                                 {game.awayTeam}
                        ...
                        <div className="w-1/4">
                           {userRole === "user" && gameHasEnded && (
                              <button
                                 className="px-3 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 "
                                 onClick={() =>
                                    handleOnGuessWinnerClick(game._id)
                                 }
                              >
                                 Spėti laimėtoja
                              </button>
                        ...
                        <div className="flex items-end">
                           <span className="font-medium pr-1 ">
                              {format(gameStartTime, "yyyy-MM-dd HH:mm", {
                                 locale: lt,
                              })}
                           </span>
                           <svg
                     ...
                     {showUpdateWinnerForm === game._id && (
                        <div className="mt-4">
                           ...
                           <UpdateWinnerForm
                              gameId={game._id}
                              teams={[game.homeTeam, game.awayTeam].map(
